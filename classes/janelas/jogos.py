...
class CategoriaJogo:
    ...
    def abrir_janela_menu(self):
        ...
        customtkinter.CTkLabel(self.janela_principal, text="Plataforma: ", font=("Arial", 16)).grid(row=0, column=3,padx=10, pady=10,sticky="W")
        plataforma_produto = customtkinter.CTkEntry(self.janela_principal, font=("Arial", 16))
        ...
        customtkinter.CTkLabel(self.janela_principal, text="Sistema de Gestão de Stock", font=("Arial", 16)).grid(row=2, column=0, columnspan=10, pady=10, padx=10, sticky="NSEW")
