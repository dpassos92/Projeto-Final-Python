...
class JanelaPesquisarLivro:
    def __init__(self):
        ...
        self.janela_pesquisar_livro_lbl = Label(self.janela_pesquisar_livro, text='Informação Livro', font='Arial 20')
        self.janela_pesquisar_livro_lbl.grid(row=0, column=0, columnspan=2, padx=50, pady=50)

        # criar campo para o título do livro
        self.janela_pesquisar_livro_lbl = Label(self.janela_pesquisar_livro, text='Título', font='Arial 14')
        self.janela_pesquisar_livro_lbl.grid(row=1, column=0, padx=(10,0), pady=10, sticky='W')
        ...
        self.janela_pesquisar_livro_lbl = Label(self.janela_pesquisar_livro, text='Ano', font='Arial 14')
        self.janela_pesquisar_livro_lbl.grid(row=3, column=0, padx=(10,0), pady=10, sticky='W')
        self.janela_pesquisar_livro_entry = Entry(self.janela_pesquisar_livro, font='Arial 14')
        self.janela_pesquisar_livro_entry.grid(row=3, column=1, padx=(0,10), pady=10, sticky='W')
