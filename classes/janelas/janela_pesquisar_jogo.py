...
class JanelaPesquisarJogo:
    def __init__(self):
        ...
        self.texto_jogo_lbl = Label(self.janela_pesquisar_jogo, text='Informação Jogo', font='Arial 20')
        self.texto_jogo_lbl.grid(row=0, column=0, columnspan=2, padx=50, pady=50)

        # criar campo para o título do jogo
        self.titulo_jogo_lbl = Label(self.janela_pesquisar_jogo, text='Título', font='Arial 14')
        self.titulo_jogo_lbl.grid(row=1, column=0, padx=(10,0), pady=10, sticky='W')
        self.titulo_jogo_entry = Entry(self.janela_pesquisar_jogo, font='Arial 14')
        self.titulo_jogo_entry.grid(row=1, column=1, padx=(0,10), sticky='W')

        # criar campo para a plataform do jogo
        self.plataforma_jogo_lbl = Label(self.janela_pesquisar_jogo, text='Plataforma', font='Arial 14')
        self.plataforma_jogo_lbl.grid(row=2, column=0, padx=(10,0), pady=10, sticky='W')
        self.plataforma_jogo_entry = Entry(self.janela_pesquisar_jogo, font='Arial 14')
        self.plataforma_jogo_entry.grid(row=2, column=1, padx=(0, 10), pady=10, sticky='W')

        # criar capo para o ano do jogo
        self.ano_jogo_lbl = Label(self.janela_pesquisar_jogo, text='Ano', font='Arial 14')
        self.ano_jogo_lbl.grid(row=3, column=0, padx=(10,0), pady=10, sticky='W')
        self.ano_jogo_entry = Entry(self.janela_pesquisar_jogo, font='Arial 14')
        self.ano_jogo_entry.grid(row=3, column=1, padx=(0,10), pady=10, sticky='W')
